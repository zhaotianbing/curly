...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly
```

A live public deployment of this template is available at [https://curly.templates.workers.dev](https://curly.templates.workers.dev)
